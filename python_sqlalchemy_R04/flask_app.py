...
def result():
    ...
    if input_name == none_name or input_travelcosts == none_travelcosts or input_date == none_date:
    ...
    return render_template('result.html', message = message, name = input_name, travel_costs = input_travelcosts, date = input_date)
